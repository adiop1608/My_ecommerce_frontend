...
const handleSearchFocus = () => {
  ...
  return (
    <nav className = "div1 bg-white text-black min-w-full h-28 flex flex-row items-center p-7 text-nowrap shadow-lg style-none relative ">
      <Link to="/dashboard">
      ...
      <a href="" className="hidden md:flex">
        <FontAwesomeIcon
          icon={faSearch}
          className=" hidden  mt-[3.5px] ml-30 mr-3 hover:text-amber-200"
        />
      </a>
      ...
      <ul className="hidden md:flex flex-row">
        ...
        <Link to="/admin">
{user && user.role === "Admin"&&(        <li className="mr-10 ml-10  hover:text-blue-500  hover:underline hover:underline-offset-8 cursor-pointer">
          <FontAwesomeIcon
            icon={faUserTie}
            className=" inline-block mt-[3.5px] mr-3"
            />
...
<div className="ml-auto relative md:hidden">
        ...
        {dropdownOpen && (
          <ul className="absolute right-0 mt-2 w-48 bg-black text-white border border-gray-700 rounded-lg shadow-lg p-2">
            ...
            <Link to="/admin">
            {user && user.role === "Admin"&&(<li className="px-4 py-2 hover:text-blue-400 cursor-pointer flex items-center">
